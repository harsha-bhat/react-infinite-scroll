...
var Layout = function (_React$Component) {
  ...
  _createClass(Layout, [{
    ...
    key: 'loadNextItem',
    value: function loadNextItem(callback) {
      fetch('/api?index=' + this.state.index).then(function (res) {
        return res.json();
      }).then(function (json) {
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'layout' },
        _react2.default.createElement(_List2.default, { items: this.state.articles }),
        _react2.default.createElement(_Sidebar2.default, { top: this.state.top })
      );
    }
  }]);
...
},{"./List":170,"./Sidebar":171,"react":167,"whatwg-fetch":168}],170:[function(require,module,exports){
'use strict';
...
var Sidebar = function (_React$Component) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { style: { top: this.props.top }, className: 'sidebar' },
        _react2.default.createElement(
          'h3',
          null,
          'Sidebar'
...
},{"./components/Layout":169,"react":167,"react-dom":29}]},{},[172]);
